...
Other editors: 
Kamil Sekut (kamil.sekut@gmail.com)
...
- Replaced outsheet with export delimited when writing CSV files. This avoids Stata default formatting from rounding large values in the exported files.
- The code now sums nobs_* variables when aggregating across years, instead of averaging observation counts. Other moment statistics continue to be averaged as before.
